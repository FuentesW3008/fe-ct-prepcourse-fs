...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if(objetoUsuario.email != null  || objetoUsuario.email != undefined ) return true;
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function(){
      var res = objetoProducto.precio -  ((objetoProducto.precio * objetoProducto.porcentajeDeDescuento))
      return res;
   }
